package OfficeHour.Practice_05_10_2021;
...
public class SeparateParts {
    public static void main(String[] args) {
        /** [Separate parts]
         ...
         Challenge 1: make a method that will do this action and it will
         return an ArrayList which holds all 3 of the other ArrayLists
