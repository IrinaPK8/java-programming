...
public class ArrayUtilsTest {
    public static void main(String[] args) {
       ...
       /** int [] nums = {5, 23, 1, 543, 90}; // declare array first
        ArrayUtils.printArray(nums);  // call it
        ArrayUtils.printArray(new int [] {23, 64, 23, 534, 234, 45, 234, 45});   // another way to declare and print array
